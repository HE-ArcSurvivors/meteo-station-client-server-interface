...
public interface MeteoServiceWrapper_I extends Remote
	...
	// Explication:
	//
	// 	Si on les utilise depuis le pc-central (c'est l'objectif!), le listener sera sérialié sur le pc-central
	//	et deserializer sur le pc-local.
	// 	le service météo va alors avertir l'instance sur le pc-local, instance de listener qui n'a 
	//	aucune connexion avec celle sur le pc central.
	// 	L'instance sur le pc-central ne sera alors jamais avertie (ce qui est l'objectif)
	//
	// Tip
	//	On pourrait malgré tout les utiliser en injectant un listener auto-shared et auto-conencted
	//  en customizant la serilalization et deserialization!
	//	Très intéressant! Contact cedric.bilat@he-arc.ch pour plus de détails sur cette technique!
