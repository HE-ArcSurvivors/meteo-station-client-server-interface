...
//	JDialogSettings jdialogsettings;
//
...
//		this.frame = frame;
//		jdialogsettings = new JDialogSettings(frame, "geisel", this);
...
//		label = new JLabel("Click the \"Show it!\" button" + " to bring up the selected dialog.", SwingConstants.CENTER);
//
//		//Lay them out.
...
//						{
//						jdialogsettings.setLocationRelativeTo(frame);
//						jdialogsettings.setVisible(true);
//
//						String s = jdialogsettings.getValidatedText();
//						if (s != null)
//							{
//							//The text is valid.
